...
GRANT SELECT ON ${database}.parser_category_targets TO 'uslugi_parser'@'%';
GRANT SELECT ON ${database}.yandex_occupations TO 'uslugi_parser'@'%';
GRANT SELECT ON ${database}.yandex_specializations TO 'uslugi_parser'@'%';
GRANT SELECT ON ${database}.yandex_services TO 'uslugi_parser'@'%';
GRANT SELECT ON ${database}.category_yandex_occupations TO 'uslugi_parser'@'%';
GRANT SELECT ON ${database}.category_yandex_specializations TO 'uslugi_parser'@'%';
GRANT SELECT ON ${database}.category_yandex_services TO 'uslugi_parser'@'%';
...
GRANT SELECT, INSERT, UPDATE ON ${database}.yandex_occupations TO 'uslugi_admin'@'%';
GRANT SELECT, INSERT, UPDATE ON ${database}.yandex_specializations TO 'uslugi_admin'@'%';
GRANT SELECT, INSERT, UPDATE ON ${database}.yandex_services TO 'uslugi_admin'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON ${database}.category_yandex_occupations TO 'uslugi_admin'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON ${database}.category_yandex_specializations TO 'uslugi_admin'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON ${database}.category_yandex_services TO 'uslugi_admin'@'%';
