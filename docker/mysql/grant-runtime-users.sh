...
GRANT SELECT ON ${database}.category_yandex_occupations TO 'uslugi_admin'@'%';
GRANT SELECT ON ${database}.category_yandex_specializations TO 'uslugi_admin'@'%';
GRANT SELECT ON ${database}.category_yandex_services TO 'uslugi_admin'@'%';
