...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'parser' => [
            'driver' => 'mysql',
            'url' => env('PARSER_DB_URL'),
            'host' => env('PARSER_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('PARSER_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('PARSER_DB_DATABASE', env('DB_DATABASE', 'uslugi')),
            'username' => env('PARSER_DB_USERNAME', env('DB_USERNAME', 'uslugi')),
            'password' => env('PARSER_DB_PASSWORD', env('DB_PASSWORD', '')),
            'unix_socket' => env('PARSER_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                (PHP_VERSION_ID >= 80500 ? Mysql::ATTR_SSL_CA : PDO::MYSQL_ATTR_SSL_CA) => env('PARSER_MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
