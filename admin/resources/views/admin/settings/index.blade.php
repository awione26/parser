...
<section class="content settings-page">
    <div class="container-fluid">
        <div class="alert alert-info settings-notice" role="status">
            ...
            <div>
                Изменения применятся при следующем запуске парсера. Работа выполняется в рамках
                письменного разрешения Яндекса; оно оформляется отдельно и не является настройкой парсера.
            </div>
        </div>
